...
public class Email {
    ...
    public Email(int EmailId, String From, String To, String labelFrom, ArrayList<String> labelTo, ArrayList<String> Cc, ArrayList<String> Bcc, Timestamp Date, String Subject, String Content) {
        this.EmailId = EmailId;
        this.From = From;
        this.To = To;
        this.labelFrom = labelFrom;
    ...
    public Email(int EmailId, String From, String To, String labelFrom, ArrayList<String> labelTo, ArrayList<String> Cc, ArrayList<String> Bcc, Timestamp Date, String Subject, String Content, ArrayList<Attachment> Attachments) {
        this.EmailId = EmailId;
        this.From = From;
        this.To = To;
        this.labelFrom = labelFrom;
